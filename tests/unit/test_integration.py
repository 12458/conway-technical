...
@pytest.mark.unit
class TestDatabaseToResponse:
    """Tests for converting database models to response models."""

    def test_database_to_response(self):
        ...
        summary = AnomalySummary(
            ...
            severity="high",
            severity_reasoning="Classified as HIGH due to force push by new account",
...
@pytest.mark.unit
class TestSSEMessageCreation:
    """Tests for creating SSE messages from database models."""
    ...
    def test_connected_message_creation(self):
...
class TestBackwardCompatibility:
    """Tests for backward compatibility with old to_dict() method."""
